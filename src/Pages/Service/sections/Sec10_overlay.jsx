...
const Sec10_overlay = () => {
    ...
    return (
        <div className='w-full px-4  sm:px-20 xl:px-28 3xl:px-80 z-30 grid xl:grid-cols-2 grid-cols-1 sm:gap-10   text-textDark bg-primaryDark relative md:py-20 sm:p-16 p-4 '>
            ...
            <div data-aos="fade-top" className=' mx-auto md:w-[750px] sm:w-[600px] w-[400px]   3xl:h-[32rem] h-[35rem]  order-2 lg:order-1 ' style={{ backgroundImage: `url("https://res.cloudinary.com/dqflexfdy/image/upload/v1754813008/sec10_overlay_qrtsge.jpg")`, backgroundSize: 'contain', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }} />
